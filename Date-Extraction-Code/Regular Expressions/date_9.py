## This file contains the function date_form_9
...
def date_form_9(text, date_form = 'raw', languages = ['en'], year_prefix = '20'):
    ...
    complete_RE = re.compile(month_re + breaks_re + date_re + "(" + breaks_re + dow_re + ")?" + "(" + breaks_re + "(')?" + year_re + ")?")  # RE to extract entire date
