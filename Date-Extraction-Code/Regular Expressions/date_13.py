## This file contains the function date_form_13
...
def date_form_13(text, date_form = 'raw', languages = ['en'], year_prefix = '20'):
    ...
    complete_RE = re.compile("(" + "(')?" + year_re + breaks_re + ")?" + month_re + breaks_re + "(" + dow_re + breaks_re + ")?" + date_re)  # RE to extract entire date
