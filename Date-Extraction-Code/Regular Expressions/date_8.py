## This file contains the function date_form_8
...
def date_form_8(text, date_form = 'raw', languages = ['en'], year_prefix = '20'):
    ...
    complete_RE = re.compile("(" + "(')?" + year_re + breaks_re + ")?" + "(" + dow_re + breaks_re + ")?" + date_re + breaks_re + '(of )?' + month_re)  # RE to extract entire date
