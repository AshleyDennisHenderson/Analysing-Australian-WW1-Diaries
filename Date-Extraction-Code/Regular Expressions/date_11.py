## This file contains the function date_form_11
...
def date_form_11(text, date_form = 'raw', languages = ['en'], year_prefix = '20'):
    ...
    complete_RE = re.compile(month_re + "(" + breaks_re + "(')?" + year_re + ")?" + "(" + breaks_re + dow_re + ")?" + breaks_re + date_re)  # RE to extract entire date
