## This file contains the function date_form_5
...
def date_form_5(text, date_form = 'raw', languages = ['en'], year_prefix = '20'):
    ...
    complete_RE = re.compile(date_re + breaks_re + "(" + dow_re + breaks_re + ")?"+ "(" + "(')?" + year_re + breaks_re + ")?" + month_re)  # RE to extract entire date
