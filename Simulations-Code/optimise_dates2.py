...
def optimise_dates2(date_list, I_list, sd, sy, alpha, beta, gamma, delta, omega):
...
##    model.k = Var(model.i, within = Boolean)
...
##    model.const2 = Constraint(model.i, rule = rule_2)
